...
# TODO: hash to customer class?
  ...
  private
    ...
    def hash_to_order (order_hash)
      ...
      return Order.new(order_hash['OrderID'], order_hash['BillingFirstName'], order_hash['BillingLastName'], customer['EmailAddress'], line_items)
    end
    
    def hash_to_line_item (order_detail_hash)
      LineItem.new(order_detail_hash['OrderDetailID'], order_detail_hash['ProductName'], order_detail_hash['ProductID'], order_detail_hash['ProductPrice'])
    end
